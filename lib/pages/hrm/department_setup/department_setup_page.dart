...
_sectionPart(DepartmentSetupController econtroller) => customFixedHeightContainer(
...
_categoryEntryPart(DepartmentSetupController econtroller) => Container(
      ...
      child: Row(
        children: [
          ...
          width(),
          roundedButton(() {
            econtroller.saveUpdateCategory();
          },
                      ...
                      children: econtroller.category_list.map((element) {
                        return Container(
                          ...
                          decoration: customBoxDecoration.copyWith(
                              borderRadius: BorderRadius.circular(0),
                              color:
                                  econtroller.editCategoryID.value == element.id
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () {
                                      ...
                                      econtroller.editCategoryID.value =
                                          element.id.toString();
                                      econtroller.cmb_category_statusID.value =
...
_departmentTableView(DepartmentSetupController econtroller) => Padding(
    padding: const EdgeInsets.symmetric(horizontal: 8),
    child: econtroller.isDepartmentLoading.value
        ? const Center(child: CupertinoActivityIndicator())
            ...
            child: Table(
              ...
              children: [
                ...
                for (var element in econtroller.department_list_all)
                  TableRow(
                    decoration: BoxDecoration(
                      color: econtroller.editDepartmentID.value != element.id
                          ? Colors.white
                          : Colors.amber.withOpacity(0.3),
                    ),
                    children: [
                      ...
                      TableCell(
                        ...
                        child: Padding(
                          ...
                          child: Center(
                              child: InkWell(
                            onTap: () {
                              econtroller.editDepartmentID.value = element.id!;
                              econtroller.txt_department.text = element.name!;
                              econtroller.cmb_catID.value = element.catId!;
                              econtroller.cmb_department_statusID.value =
                                  element.status!;
                            },
                            child: const Icon(
                              Icons.edit,
...
_sectionTableViewPart(DepartmentSetupController econtroller) => Padding(
      padding: const EdgeInsets.symmetric(horizontal: 8),
      child: econtroller.isSectionLoading.value?const Center(child: CupertinoActivityIndicator()) :SingleChildScrollView(
        child: Table(
          columnWidths: const {
