...
_desktopTab(BuildContext context, EmployeeController econtroller,[bool isMob=false]) =>
    SingleChildScrollView(
      child: Padding(
                      ...
                      children: [
                        Expanded(
                          child: CustomDropDown(
                              ...
                              list:
                                  _getDropdownItem(econtroller, "designation"),
                              onTap: (v) {
                                econtroller.cmb_designation.value =
                                    v.toString();
                              },
                              width: 100),
                        ),
                      ...
                      children: [
                        Expanded(
                          child: CustomDropDown(
                              ...
                              list:
                                  _getDropdownItem(econtroller, "jobcategory"),
                              onTap: (v) {
                                econtroller.cmb_jobcategory.value =
                                    v.toString();
                              },
                              width: 100),
                        ),
