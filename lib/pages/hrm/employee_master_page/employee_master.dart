...
_photoPart() => const Padding(
      ...
      child: _PhorPart(), //_rightPart(context, _image),
    );
...
_middlePart(BuildContext context, EmployeeController econtroller) {
  ...
  return Container(
    ...
    child: Column(
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        CustomCaptionForContainer("General Official Information:"),
        const SizedBox(
          height:  8 ,
        ),
        Padding(
...
class _PhorPart extends StatelessWidget {
  const _PhorPart({super.key});
  @override
  Widget build(BuildContext context) {
    File? image;
    return Container(
