...
_leftPart(DoctorOPDsetupController econtroller) {
  return customChildrenContainer("Doctor Information", [
...
_rightPart(DoctorOPDsetupController econtroller) {
  return  customChildrenContainer(
    "Fees Information",
    [
               ...
               // leftIcon:SizedBox(),
                children: [
                 ...
                 // leftIcon: const Icon(Icons.input, color: Colors.white),
                  header: CustomCaptionForContainer("Testing"),
  ...
  //               Column(
  //                 children: [
  //                   CustomCaptionForContainer("Visiting fees details",
  //                       kWebBackgroundDeepColor, Colors.grey.shade400),
  //                   Padding(
  //                     padding: const EdgeInsets.all(8.0),
  //                     child: Row(
  ...
  return Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        height(),
        Expanded(
          child: customFixedHeightContainer(
              "Doctor List",
              [
                Row(
                  children: [
