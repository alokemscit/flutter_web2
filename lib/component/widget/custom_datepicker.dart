...
class CustomDatePickerDropDown extends StatefulWidget {
  ...
  CustomDatePickerDropDown(
      ...
      this.labelFontSize = 12,this.hintText='DD/MM/YYYY'});
...
class _CustomDatePickerDropDownState extends State<CustomDatePickerDropDown> {
  ...
  Widget _cText(dynamic widget) => TextFormField(
              ...
              PopupMenuItem<int>(
                ...
                child: SizedBox(
                  ...
                  child: Theme(
                    ...
                    child: CalendarDatePicker(
                      currentDate: widget.date_controller.text.length==10?DateFormat("dd/MM/yyyy").parse(widget.date_controller.text):null,
                      initialDate:widget.date_controller.text.length==10?DateFormat("dd/MM/yyyy").parse(widget.date_controller.text): DateTime.now(),
                      firstDate:
        ...
        onChanged: (value) {
         ...
         readOnly: widget.isBackDate?false: true,
        inputFormatters: [
          //dateFormatter,
