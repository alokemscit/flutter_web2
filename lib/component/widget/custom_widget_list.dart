...
class MyWidget {
 ...
 static CustomDropDown2 DropDown = CustomDropDown2(id: null, list: [], onTap: (v) {});
 ...
 static CustomTableColumnHeaderBlackNew TableColumnHeader =
  ...
  static CustomCloseButtonRounded ButtonRound = CustomCloseButtonRounded(onTap: () {});
...
// Widget mGetWidget(WidgetType wt, {Map<String, dynamic>? params}) {
//   switch (wt) {
//     case WidgetType.textbox:
//       return CustomTextBox(
//         caption: params?['caption'] ?? '', // Use passed caption if available
//         controller: params?['controller'] ?? TextEditingController(),
//         textInputType: params?['inputType'] ?? TextInputType.text,
//         onChange: params?['onChange'] ?? (v) {},
//       );
//     case WidgetType.chchbox:
//       return Checkbox(value: false, onChanged: (v) {});
//     case WidgetType.dropdown:
//       return CustomDropDown2(id: null, list: [], onTap: (v) {});
//     case WidgetType.searchbox:
...
//       return CustomGroupBox(child: SizedBox());
//     case WidgetType.tableheader:
//       return CustomTableColumnHeaderBlackNew(
//         text: '',
//       );
//     case WidgetType.tablecell:
//       return CustomTableCellx(text: '');
//     default:
//       return const SizedBox(); // Default icon
//   }
// }
