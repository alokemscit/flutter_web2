...
Widget CommonBodyWithToolBar1(dynamic controller, List<Widget> children,
  ...
  if (controller.list_tools.isEmpty) {
    controller.list_tools.value = Custom_Tool_List();
  }
...
class CustomTool extends StatefulWidget {
  ...
  CustomTool(
      ...
      this.borderRadius = 4,
      this.pading = const EdgeInsets.symmetric(horizontal: 8, vertical: 6),
      this.isRevarse = false});
}
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(
                            widget.borderRadius) // Change color on hover
                        ),

                    padding:
                        widget.pading, // Optional padding for better appearance
                    child: Row(
                      children: [
                        Icon(
        ...
        child: Row(
          children: [
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                border: Border.all(color: appColorGrayDark, width: 0.1),
                color: _isPressed
...
class MyWidget {
  ...
  CustomDropDown2 DropDown = CustomDropDown2(id: null, list: [], onTap: (v) {});
  ...
  CustomCloseButtonRounded ButtonRound = CustomCloseButtonRounded(onTap: () {});
...
class CustomSearchableDropdown<T> extends StatefulWidget {
  ...
  CustomSearchableDropdown({
    ...
    this.FontWidth = FontWeight.w500,
