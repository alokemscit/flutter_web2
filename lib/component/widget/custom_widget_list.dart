...
class CustomTextHeader extends StatelessWidget {
  const CustomTextHeader(
      {super.key, required this.text,  this.textSize=13,this.textColor=Colors.black });
  final String text;
  ...
  Widget build(BuildContext context) {
    return Text(
      text,
      style: customTextStyle.copyWith(fontWeight: FontWeight.bold,fontSize: textSize,color:textColor),
    );
  }
}
        ...
        children: [
          ...
          Container(
              ...
              child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Column(
                    children: children.isEmpty?[8.heightBox]:children,
                  ))) 
          ]);
