...
static Future<void> generatePDF(Widget header,List<Widget> body,Widget footer,[bool isLandScape=false]) async {
  final pdf = Document();
    ...
    PdfPageFormat pageFormat =isLandScape? const PdfPageFormat( 297 * PdfPageFormat.mm,210 * PdfPageFormat.mm):const PdfPageFormat(210 * PdfPageFormat.mm, 297 * PdfPageFormat.mm);
  pdf.addPage(
    MultiPage(
