      ...
      return Center(
        child: AlertDialog(
          ...
          children: [
            ...
            CustomTool(
              isHovered: false,
              menu: ToolMenuSet.exit,
              borderRadius: 8,
              pading: const EdgeInsets.symmetric(vertical: 4, horizontal: 4),
              isRevarse: true,
              onTap: () {
               // if (Navigator.canPop(context)) {
              Navigator.of(context).pop(); // Ensure it's safe to pop
           // }
              },
            )
          ],
...
Future<void> CustomDialog2(BuildContext context, String caption, Widget body,
        [bool IsSaveButton = false, Function()? onSave]) =>
    CustomDialog(
        context,
        Text(
                caption,
