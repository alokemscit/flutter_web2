...
//isDisableID.value = false;
  ...
  SaveData() async {
    ...
    if (cmb_department_category.isEmpty) {
      dialog
        ..dialogType = DialogType.warning
        ..message = "Please select department Category"
        ..show()
        ..onTap = () {};
    ...
    if (cmb_emptype.isEmpty) {
      dialog
        ..dialogType = DialogType.warning
        ..message = "Please select type of employeement"
        ..show()
        ..onTap = () {};
    ...
    if (txt_emp_doj.text.isEmpty) {
      dialog
        ..dialogType = DialogType.warning
        ..message = "Please enter date of join"
        ..show()
        ..onTap = () {};
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Material(
                        ...
                        child: Container(
                          decoration:
                              CustomCaptionDecoration(0.5, Colors.black),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                            //  CustomAccordionContainer( headerName:  "Search Employee"),
                              8.heightBox,
                              Expanded(
                                child: Container(
