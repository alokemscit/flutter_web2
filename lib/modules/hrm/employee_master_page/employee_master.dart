...
_leftPart(EmployeeController econtroller, BuildContext context) {
  return CustomAccordionContainer( headerName: "General Information", children: [
    8.heightBox,
    Row(
...
_rightPart(BuildContext context, EmployeeController econtroller, bool isMob) =>
    CustomAccordionContainer( headerName: "General Official Information", children: [
      isMob ?8.heightBox : 130.heightBox,
      Row(
        mainAxisAlignment: MainAxisAlignment.start,
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
