...
//     CustomTool(isDisable: true, onTap: () {}, menu: ToolMenuSet.file),
//     CustomTool(isDisable: false, onTap: () {}, menu: ToolMenuSet.save),
//   ];
//   void fun1() {
//     list.where((e) => e.menu == ToolMenuSet.save).first.onTap = () {};
//   }
// //   CustomTool(
