...
Widget _empSearch(HrEmployeeProfileController controller) => CustomGroupBox(
  ...
  child: Row(children: [
    CustomTextBox( width: 100, caption: 'Emp ID', controller: TextEditingController()),4.widthBox,
    CustomRoundedButton(iconColor: appColorBlue, icon: Icons.search, bgColor: Colors.transparent, iconSize: 24, onTap: (){}),
   12.widthBox,
  Container(
    color: kGrayColor,
    height: 18,
   ...
   Row(children: [
 24.widthBox,
 CustomRoundedButton(iconColor: appColorLogoDeep, icon: Icons.edit, bgColor: Colors.transparent, iconSize: 24, onTap: (){}),
 8.widthBox,
 CustomRoundedButton(iconColor: appColorBlue, icon: Icons.undo, bgColor: Colors.transparent, iconSize: 24, onTap: (){})
    ],)
  ],),
));
