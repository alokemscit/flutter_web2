...
import 'package:web_2/core/config/const_string.dart';
  ...
  bool validation() {
    ...
    if (isNewBorn.value) {
      if (txt_mother_hcn.text == '') {
        ...
        ..message = "Please enter valid mother HCN"..show();
        return true;
      }
    }
    if (cmb_prefix.value == '') {
       dialog
        ..dialogType = DialogType.warning
        ..message = "Please select prefix"..show();
    ...
    if (txt_name.text == '') {
       dialog
        ..dialogType = DialogType.warning
        ..message = "Please enter valid name"..show();
    ...
    if (txt_dob.text == '') {
     ...
     dialog
        ..dialogType = DialogType.warning
        ..message = "Date of birth required!"..show();
    ...
    if (cmb_nationality.value == '') {
       ...
       dialog
        ..dialogType = DialogType.warning
        ..message = "Please select country/nationality!"..show();
    ...
    if (txt_father_name.text == '') {
       dialog
        ..dialogType = DialogType.warning
        ..message = "Please enter father's name!"..show();
...
dialog
        ..dialogType = DialogType.warning
        ..message = "Please select gender!"..show();
    ...
    if (cmb_religion.value == '') {
      dialog
        ..dialogType = DialogType.warning
        ..message = "Please select religion!"..show();
    ...
    if (cmb_maritalstatus.value == '') {
      dialog
        ..dialogType = DialogType.warning
        ..message = "Please select marital status!"..show();
...
dialog
        ..dialogType = DialogType.warning
        ..message = "Please select identity type!"..show();
    ...
    if (cmb_nationality.value == '') {
      dialog
        ..dialogType = DialogType.warning
        ..message = "Please select identity number!"..show();
    ...
    if (txt_cell_phone.text == '') {
      dialog
        ..dialogType = DialogType.warning
        ..message = "Cell phone/ mobile number required!"..show();
    ...
    if (txt_emergency_number.text == '') {
      dialog
        ..dialogType = DialogType.warning
        ..message = "Emergency contact number required!"..show();
    ...
    if (cmb_pat_type.value == '') {
      dialog
        ..dialogType = DialogType.warning
        ..message = "Please select patient type!"..show();
    ...
    if (cmb_corporate_company.value == '') {
       dialog
        ..dialogType = DialogType.warning
        ..message = "Please select corporate type!"..show();
    ...
    if (cmb_emergency_country.value == '') {
       dialog
        ..dialogType = DialogType.warning
        ..message = "Country required for emergency address!"..show();
    ...
    if (cmb_emergency_state.value == '') {
       dialog
        ..dialogType = DialogType.warning
        ..message = "State required for emergency address!"..show();
    ...
    if (cmb_emergency_district.value == '') {
      dialog
        ..dialogType = DialogType.warning
        ..message = "District required for emergency address!"..show();
    ...
    if (cmb_pat_type.value == '2') {
      if (txt_empid.text == '') {
         dialog
        ..dialogType = DialogType.warning
        ..message = "Please enter valid staff employee id!"..show();
