...
class SubLeaderLinkageMaster extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // print(context.width);
    return Obx(() => CommonBody2(controller, 
    _mainWidget(controller)));
  }
}

_mainWidget(SubLedgerLinkageController controller) =>CustomAccordionContainer(
  bgColor: appGray100,
  isExpansion: false,
  headerName: "Chart of Acc",height: 0, 
children: [
...
Widget _slList(SubLedgerLinkageController controller) =>
    CustomGroupBox(
      ...
      groupHeaderText:  'SL Under \\ ${controller.selectedLedger.value.cODE!} '
          ' - '
...
_responsiveDesktop(SubLedgerLinkageController controller) => Expanded(
  child: Column(
    children: [
      Expanded(
        child: Row(
              ...
              children: [
                Expanded(
                  ...
                  child: CustomGroupBox(
                    ...
                    groupHeaderText: 'Sub Ledger Linkage',
                    child: ListView(
...
_responsiveNonDesktop(SubLedgerLinkageController controller) =>
    Expanded(
      child: CustomGroupBox(
        bgColor: Colors.white,
        groupHeaderText: 'Sub Leadger Linkage',
        child: Column(
          children: [
            Expanded(
              flex: 6,
              ...
              Expanded(
                flex: 3,
                child: controller.selectedLedger.value.iD == null
                      ? const SizedBox(): _slList(controller),),
