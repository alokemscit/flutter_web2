...
import '../../modules/Inventory/inv_grn_approval/view/inv_grn_approval.dart';
import '../../modules/Inventory/inv_grn_create/view/inv_grn_create.dart';
import '../../modules/Inventory/inv_item_master/pages/inv_item_master_page.dart';
import '../../modules/Inventory/inv_nagative_adjust/view/inv_nagative_adjust.dart';
...
import '../../modules/Inventory/inv_positive_adjustment/view/inv_positive_adjust.dart';
...
import '../../modules/Inventory/inv_store_req_approval/view/inv_store_req_approval_view.dart';
...
Widget getPage(String id) {
  switch (id) {
    ...
    case '144':
      return const InvPositiveAdjustment();
    case '145':
      return const InvNagativeAdjust();
    case '152':
      return const InvStoreRequisition();
